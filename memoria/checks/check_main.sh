...
run_github_check "monero" "https://github.com/monero-project/monero/releases/latest"
#run_check "gma_check.py" "gma.txt" "gma.log"
run_check "electrum_check.py" "electrum.txt" "electrum.log"
run_github_check "bitcoind" "https://github.com/bitcoin/bitcoin/releases/latest"
#run_github_check "geth" "https://github.com/ethereum/go-ethereum/releases/latest"
#run_github_check "gpc" "https://github.com/googleads/googleads-consent-sdk-ios/releases/latest"
...
run_check "tickets_check.py" "tickets.txt" "tickets.log"
echo "done"
