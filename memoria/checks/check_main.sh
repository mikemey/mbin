...
run_check "gma_version_check.py" "gma.txt" "gma.log"
run_check "gpc_version_check.py" "gpc.txt" "gpc.log"
run_check "electrum_version_check.py" "electrum.txt" "electrum.log"
run_check "bitcoind_version_check.py" "bitcoind.txt" "bitcoind.log"
echo "done"
